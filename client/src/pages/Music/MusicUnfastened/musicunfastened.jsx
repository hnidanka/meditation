...
import smallMiracle from '../audio/smallMiracle.mp3';
import awaken from '../audio/awaken.mp3'
...
/>
      ...
      <p className={styles.pText}><Link to="/music">Do medytacji</Link></p>
        <p className={styles.medetetion}><Link to="/musicunfastened">Odprężające</Link></p>
